...
export default function Profile({ socket, username, avatar, onLogout }: { socket: Socket | null, username: string, avatar: string | null, onLogout: () => void }) {
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (res.ok && socket) {
        ...
        // We rely on local state refresh conceptually or the parent passing the updated avatar.
        // For simplicity, a full page reload or letting parent handle it works. Let's just reload.
